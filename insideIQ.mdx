...
Simply navigate to "My Dashboard" screen and open the InsideIQ chat window and type your question in plain English. The more specific you are, the better the answer will be.
...
| **Read (R)**    | Events           | "Are there any active events on my DIA service in London?"                                  | InsideIQ queries the event management system and reports the status of any relevant alarms.                                |
...
| **Update (U)**  | Bandwidth        | "Increase the bandwidth of the circuit `ZYO-54321` to 2 Gbps."                              | InsideIQ presents a summary of the change and the associated cost, then asks for confirmation to proceed.                  |
