...
description: "A comprehensive guide to creating, managing, and monitoring your network infrastructure using the NaaS portal."
---
...
<CardGroup cols={2}>
  <Card title="Ports" icon="ethernet" href="/docs/build-your-network/ordering-ports">
  ...
  <Card title="Cloud Links" icon="cloud" href="/docs/build-your-network/cloud-links">
  ...
  <Card title="Public IPs" icon="globe" href="/docs/build-your-network/public-ips">
  ...
  <Card title="Cloud Router" icon="route" href="/docs/build-your-network/cloud-router">
  ...
  <Card title="My Services" icon="cogs" href="/docs/build-your-network/my-services">
  ...
  <Card title="Virtual Circuits" icon="circle-nodes" href="/docs/build-your-network/virtual-circuit">
  ...
  <Card title="Order Log" icon="list-alt" href="/docs/build-your-network/order-log">
