...
You'll also need the following information from Zayo, which is provided during provisioning:

- Zayo BGP peer IP address (IPv4 and/or IPv6)
- Zayo remote ASN (`6461`)
- BGP authentication password, if required
...
- The BGP authentication password, if one was provided.
