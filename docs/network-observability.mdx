...
| Widget | Description |
| --- | --- |
| **Location** | Traffic volume over time broken down by physical location (e.g., Lab\_Network\_NJ) |
| **Segments** | Traffic volume over time broken down by network segment type (e.g., Internal) |
| **Source Connection** | Traffic volume over time broken down by source connection name (e.g., Lab\_AWS\_Connection, Lab\_VPN\_Connection) |
