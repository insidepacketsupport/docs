---
title: "Create an E-Line Connection"
sidebarTitle: "Create an E-Line"
---

E-Lines are EVPLs that connect exactly two endpoints (A-side and Z-side ports) creating a transparent Layer 2 link between sites:
