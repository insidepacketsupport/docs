...
The DIA Firewall supports web filtering as an action type. When you select **Web Filtering** as the action, you can:

- **Content Filtering**: Block types of websites (adult websites, social media, etc)
- **Web Threats Filtering**: Protect against phishing URLs, spam, malicious websites, and other domains
- **Custom URL Filtering**: Create custom allow/deny lists using specific URLs

| Field                     | Description                                                                                                                                                                                                                                                                                  |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Default filter action** | The default filter action indicates how you want to handle ALL web traffic except for the specified URLs. <ul> <li> **Allow**  - Allow all web traffic, but block specific URLs</li>  <li> **Block**  - Block all web traffic, but allow specific URLs</li>  </ul> |
| **URL**                   | Enter the URL for the whitelisted/blacklisted websites                                                                                                                                                                                                                                       |
...
To apply web filtering to outbound traffic:

1. **Name**: `Web-Filter-Social-Media`
2. **Priority**: `100`
3. **Direction**: `Outgoing`
4. **Action**: `Web Filtering`
5. **Protocol**: `TCP`
6. **Destination Port**: `80,443`
7. **DIA Connection**: Select your DIA connection
8. Configure web filtering categories or custom URLs as needed
