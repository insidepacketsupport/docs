...
description: "Troubleshooting Poor Application Performance Diagnose poor application performance—from network and server to DNS issues—using the insidepacket platform's comprehensive observability tools. This guide walks through a systematic approach to finding the root cause."
---
...
1. Navigate to the **"Insight"** tab in the  portal.
...
By systematically following these steps, you can effectively diagnose the root cause of poor application performance using the DynamicLink platform.