...
> **Note:**<br />Ordered ports will appear with a `Pending` status until approved and provisioned by the Administrator. This typically takes a few hours. Track progress in the **Order Log** tab.
