---
title: "How to Use Web Filtering"
description: "Learn what web filtering is and how to configure it to control web traffic in the DynamicLink portal."
---

## What is Web Filtering?

Web filtering, when enabled as a service for a tenant in the  platform, provides granular control over web traffic by allowing you to define policies to either block or permit access to specific URLs or categories of web content.
...
## How to Use Web Filtering in the DynamicLink  Portal
