...
<CardGroup cols={2}>
  <Card title="Default DDoS Policies" icon="shield-check" href="#default-ddos-policies">
    A foundational safety net for all tenant DIAs and the core system itself. These rules are always on.
  </Card>
  <Card title="DDoS Templates" icon="file-invoice" href="#ddos-templates">
...
![Dialog for creating a new default DDoS rule.](https://placehold.co/800x450/334155/E2E8F0?text=Default+DDoS+Rule+Dialog)
...
![UI for configuring a DDoS template with device type options.](https://placehold.co/800x500/334155/E2E8F0?text=DDoS+Template+Configuration)
...
<CardGroup cols={2}>
  <Card title="Quiet Time" icon="check-circle" color="#28a745">
    ...
    <img
      className="mt-4"
      src="https://placehold.co/600x350/28a745/FFFFFF?text=Quiet+Time+Dashboard"
      alt="Dashboard showing no active attacks."
    />
  </Card>
  <Card title="Under Attack" icon="shield-exclamation" color="#dc3545">
    ...
    <img
      className="mt-4"
      src="/Services/image/attack.png"
      alt="Dashboard showing an active DDoS attack with details."
      title="attack"
    />
  </Card>
</CardGroup>
...
![Tenant view for managing DDoS rules.](https://placehold.co/800x400/334155/E2E8F0?text=Tenant+Rule+Management)